...
//unique is whether or not the field must be a unique value (meaning no two Dog object can have the same value for that field)
...
//In this case each Dog will have its own sayName function that prints the values from the object
...
//Create the Dog model based on the schema. You provide it with a custom discriminator (the name of the object type. Can be anything)
